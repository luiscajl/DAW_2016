...
export class RecetaService{
  ...
  getReceta(nombre: string) {
    ...
    return withObserver(new receta(rceta.nombre,rceta.fecha,rceta.descripcion,rceta.infoextra,rceta.dificultad,rceta.tiempo,rceta.autor,rceta.ingredientes,rceta.pasos));
  }
