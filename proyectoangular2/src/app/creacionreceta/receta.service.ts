...
export class RecetaService{
  ...
  private recetas = [
     ...
     new receta('Macarrones','22/05/2016','Una receta muy sencilla pa crear unos macarrones','','Facil','30 minutos',new register('frost','1234','12345','paco@gmail.com', 'Maestro de los fogones','Nuevo usuario', 'img/userpic.png','img/food.jpg'),["Tomate","Macarrones"],["La metemos al micro","Y lo sacamos del micro"],'',false,false,false,false,[]),
     new receta('Pizza','22/05/2016','Una receta para hacer una pizza muy hermosa','','Tirao','20 minutos',new register('frost','1234','12345','paco@gmail.com', 'Maestro de los fogones','Nuevo usuario', 'img/userpic.png','img/food.jpg'),[],[],'',false,false,false,false,[])
